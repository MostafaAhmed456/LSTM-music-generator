...
def music_inference_model(LSTM_cell, densor, n_values = 78, n_a = 64, Ty = 100):
    ...
    # Step 1: Create an empty list of "outputs" to later store  predicted values 
    outputs = []
...
def predict_and_sample(inference_model, x_initializer = x_initializer, a_initializer = a_initializer, 
    ...
    # Step 1: Use  inference model to predict an output sequence given x_initializer, a_initializer and c_initializer.
